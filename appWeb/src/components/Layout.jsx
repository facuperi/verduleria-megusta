...
export const Layout = ({ children }) => {
  ...
  const NavLink = ({ item, onClick }) => (
    ...
    >
      <svg className={`w-5 h-5 shrink-0 ${isActive(item.path) ? 'text-indigo-400' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 flex">
      {user && !isMobile && (
        <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
          <div className="flex flex-col flex-1 min-h-0 bg-gray-950 border-r border-gray-800">
            <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-800">
              ...
              <div>
                <h1 className="text-base font-bold text-white leading-tight">santos</h1>
            ...
            <div className="px-3 py-4 border-t border-gray-800">
              ...
              <button
                onClick={toggleTheme}
                className="flex items-center gap-3 w-full px-4 py-2.5 rounded-lg text-sm font-medium text-gray-400 hover:bg-gray-800 transition-colors mb-1"
              >
                {theme === 'dark' ? (
              ...
              <button
                ...
                className="flex items-center gap-3 w-full px-4 py-2.5 rounded-lg text-sm font-medium text-gray-400 hover:bg-gray-800 hover:text-red-400 transition-colors"
              >
                <svg className="w-5 h-5 shrink-0 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {user && isMobile && sidebarOpen && (
        <div className="fixed inset-0 z-40 flex md:hidden">
          ...
          <div className="relative flex flex-col flex-1 max-w-xs w-full bg-gray-950">
            <div className="flex items-center justify-between px-4 py-4 border-b border-gray-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-sm font-bold text-white leading-tight">santos</h1>
      ...
      <div className={`flex-1 flex flex-col ${user ? 'md:pl-64' : ''}`}>
        {user && (
          <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-gray-200 md:hidden">
            <div className="flex items-center justify-between px-4 h-14">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-gray-900 text-sm">santos</span>
              </div>
              <div className="w-10" />
            </div>
          </header>
      ...
      <Modal open={showLogoutModal} onClose={() => setShowLogoutModal(false)} title="Cerrar sesión">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex-1 bg-gray-600 text-gray-200 py-2 px-4 rounded-lg hover:bg-gray-500 transition-colors text-sm font-medium"
          >
            Cancelar
          </button>
        </div>
